...
import com.trung.moneyrecognizer.LabelListener
...
class MoneyAnalyzer(private val listener: LabelListener) : ImageAnalysis.Analyzer {
    ...
    val labelList = mutableListOf<String>("0","1.000VND","5.000VND","10.000VND","20.000VND","50.000VND","2.000VND","100.000VND","200.000VND","500.000VND")
